## Alturas
## Fazer um programa para ler um número inteiro N e depois os dados (nome, idade e altura) de N pessoas. Em seguida, mostrar a altura média das pessoas, mostrar a porcentagem de pessoas com menos de 16 anos e listar os nomes
## dessas pessoas.
...
idades: [int] = [0 for x in range(n)] # type: ignore
alturas: [float] = [0 for x in range(n)] # type: ignore
